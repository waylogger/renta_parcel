...
function intervalToArray(arrayOfIntervals) {
  ...
  arrayOfIntervals.forEach(function (interval) {
    ...
    start = (0, _dateFns.addMinutes)(start, start.getTimezoneOffset());
    end = (0, _dateFns.addMinutes)(end, end.getTimezoneOffset());

    if ((0, _dateFns.format)(end, 'HH:mm:ss') === '00:00:00' && (0, _dateFns.format)(end, "yyyy:MM;dd") != "".concat(end.getFullYear(), ":12;31")) {
      end = (0, _dateFns.addMinutes)(end, -60);
    }
