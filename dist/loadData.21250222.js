...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","../connection/index":"static/connection/index.js","../state/dataFromServer":"static/state/dataFromServer.js"}],"node_modules/date-fns/esm/_lib/toInteger/index.js":[function(require,module,exports) {
"use strict";
...
},{"../_lib/requiredArgs/index.js":"node_modules/date-fns/esm/_lib/requiredArgs/index.js","../constants/index.js":"node_modules/date-fns/esm/constants/index.js"}],"node_modules/date-fns/esm/min/index.js":[function(require,module,exports) {
"use strict";
...
},{"../toDate/index.js":"node_modules/date-fns/esm/toDate/index.js","../_lib/requiredArgs/index.js":"node_modules/date-fns/esm/_lib/requiredArgs/index.js"}],"node_modules/date-fns/esm/minutesToHours/index.js":[function(require,module,exports) {
"use strict";
...
function intervalToArray(arrayOfIntervals) {
  ...
  arrayOfIntervals.forEach(function (interval) {
    var start = new Date(interval.begin);
    var end = new Date(interval.end);
    res.push((0, _esm.eachDayOfInterval)({
      start: start,
      end: end
    }));
  }); // console.log(res);
  ...
  _getFreePeriods = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            if (_dataFromServer.dataFromServer.currentCar) {
              _context.next = 2;
              break;
            }
          ...
          case 2:
            if (_dataFromServer.dataFromServer.currentCar instanceof Array) {
              _context.next = 4;
              break;
            }
          ...
          case 4:
            promises = [];
            begin = _dataFromServer.dataFromServer.beginFetchPeriod;
            end = _dataFromServer.dataFromServer.endFetchPeriod;

            _dataFromServer.dataFromServer.currentCar.forEach(function (item) {
              var placeObj = {
                car_id: item.car_id,
                begin: begin,
                end: end,
              ...
              promises.push((0, _index.getCarPeriodList)(placeObj));
            });
...
exports.createPlaceSelect = createPlaceSelect;
...
function createOption(data, cost) {
  var freeHTML = "\n\t<option>\n\t<span>\n\t\t".concat(data, " \n\t</span>\n</option>\n\t");
  var defHTML = "\n\t<option>\n\t\t<span>\n\t\t\t".concat(data, " <span class=\"book__field-cost-option\"> + ").concat(cost, " \u20BD</span>\n\t\t</span>\n\t</option>\n");
  var unDefHTML = "\n\t<option>\n\t\t<span>\n\t\t</span>\n\t</option>\n";
...
function createPlaceSelect() {
  return _createPlaceSelect.apply(this, arguments);
}

function _createPlaceSelect() {
  _createPlaceSelect = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var placeHTML;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            placeHTML = '';
            _context.next = 3;
            return (0, _index.getPlaceList)();

          case 3:
            _dataFromServer.dataFromServer.placesToReceiveOrReturnCar = _context.sent.places;

            _dataFromServer.dataFromServer.placesToReceiveOrReturnCar.splice(0, 3);
            ...
            _dataFromServer.dataFromServer.placesToReceiveOrReturnCar.forEach(function (item, el) {
              var rStr = item.delivery_cost > 0 ? createOption(item.title, item.delivery_cost) : createOption(item.title);
              placeHTML += rStr;
            });
...
exports.whenDataLoad = void 0;

var _carSelector = require("./components/carSelector");

var _dataFromServer = require("./state/dataFromServer");

var _fetchPeriods = require("./components/fetchPeriods");

var _placeSelector = require("./components/placeSelector");

function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

var whenDataLoad = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
...
exports.whenDataLoad = whenDataLoad;
},{"./components/carSelector":"static/components/carSelector.js","./state/dataFromServer":"static/state/dataFromServer.js","./components/fetchPeriods":"static/components/fetchPeriods.js","./components/placeSelector":"static/components/placeSelector.js"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","static/loadData.js"], null)
//# sourceMappingURL=/loadData.21250222.js.map