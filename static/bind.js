...
import $ from 'jquery';
import { bookCar, transferReceiveTime, transferReturnTime, datePreview, lawAgreementHandlerAgeExpr, lawAgreementHandlerAgreePolicy, receivePlaceHandle, costPreview, showCustomReceivePlaceInput, returnPlaceHandle, showCustomReturnPlaceInput, carPreview, inputHandler, phoneAdditional, checkingReceiveTime, checkingReturnTime, getFreeReceiveTime } from './handlers'
